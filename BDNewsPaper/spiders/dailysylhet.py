"""
Daily Sylhet Spider (Bangla)
============================
Scrapes articles from Daily Sylhet (dailysylhet.com)

Features:
    - WordPress REST API support ⚡
    - Regional news from Sylhet
...
class DailySylhetSpider(BaseNewsSpider):
    """
    Spider for Daily Sylhet using WordPress REST API.
    
    Regional Bangla news from Sylhet division.
    
    Usage:
        scrapy crawl dailysylhet
        scrapy crawl dailysylhet -a max_pages=10
    """
    
    name = 'dailysylhet'
    paper_name = 'Daily Sylhet'
    allowed_domains = ['dailysylhet.com']
    language = 'Bangla'
    ...
    # WordPress API base
    API_BASE = 'https://dailysylhet.com/wp-json/wp/v2'
    POSTS_PER_PAGE = 20
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info("Daily Sylhet spider initialized (WordPress API)")
    ...
    def start_requests(self):
        ...
        yield Request(
            url='https://dailysylhet.com/feed',
