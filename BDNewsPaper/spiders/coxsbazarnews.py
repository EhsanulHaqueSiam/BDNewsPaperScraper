"""
Coxsbazar News Spider (Bangla)
==============================
Scrapes articles from Coxsbazar News (coxsbazarnews.com)

Features:
    - Regional news from Cox's Bazar
...
class CoxsbazarNewsSpider(BaseNewsSpider):
    """
    Spider for Coxsbazar News (Regional Bangla).
    
    Cox's Bazar's first news portal covering tourism and regional news.
    
    Usage:
        scrapy crawl coxsbazarnews -a max_pages=10
    """
    
    name = 'coxsbazarnews'
    paper_name = 'Coxsbazar News'
    allowed_domains = ['coxsbazarnews.com', 'www.coxsbazarnews.com']
    language = 'Bangla'
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info("Coxsbazar News spider initialized (Regional)")
    ...
    def start_requests(self):
        ...
        yield Request(
            url='https://www.coxsbazarnews.com/sitemap.xml',
    ...
    def _generate_fallback_requests(self) -> Generator[Request, None, None]:
        ...
        # Default: main page
        url = "https://www.coxsbazarnews.com/"
        self.stats['requests_made'] += 1
        yield Request(
            url=url,
    ...
    def parse_category(self, response: Response) -> Generator:
        ...
        # Extract article links - pattern: /archives/id.html
        article_links = response.css('a::attr(href)').getall()
        article_links = [
            l for l in article_links
            if 'coxsbazarnews.com/archives/' in l
            and '.html' in l
        ...
        for url in article_links:
            if not url.startswith('http'):
                url = f"https://www.coxsbazarnews.com{url}"
        ...
        if found_count > 0 and page < self.max_pages:
            ...
            if next_page_link:
                if not next_page_link.startswith('http'):
                    next_page_link = f"https://www.coxsbazarnews.com{next_page_link}"
