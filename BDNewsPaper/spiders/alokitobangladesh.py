"""
Alokito Bangladesh Spider (Bangla)
==================================
Scrapes articles from Alokito Bangladesh (alokitobangladesh.com)
...
class AlokitoBangladeshSpider(BaseNewsSpider):
    """
    Spider for Alokito Bangladesh (Bangla Newspaper).
    
    Uses HTML scraping with category navigation.
    
    Usage:
        scrapy crawl alokitobangladesh -a categories=national,politics,sports
        scrapy crawl alokitobangladesh -a max_pages=10
    """
    
    name = 'alokitobangladesh'
    paper_name = 'Alokito Bangladesh'
    allowed_domains = ['alokitobangladesh.com', 'www.alokitobangladesh.com']
    language = 'Bangla'
    ...
    CATEGORIES = {
        ...
        'international': 'interrnational',  # Note: site has typo
        'world': 'interrnational',
        'economy': 'economy',
        'business': 'economy',
        'sports': 'sports',
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info(f"Alokito Bangladesh spider initialized")
    ...
    def start_requests(self):
        ...
        yield Request(
            url='https://www.alokitobangladesh.com/feed',
        ...
        self.stats['requests_made'] += 1
        yield Request(
            url='https://www.alokitobangladesh.com/news-sitemap.xml',
    ...
    def _generate_fallback_requests(self) -> Generator[Request, None, None]:
        ...
        if self.categories:
            for category in self.categories:
                ...
                url = f"https://www.alokitobangladesh.com/{cat_slug}"
    ...
    def parse_category(self, response: Response) -> Generator:
        ...
        # Filter to article links (contain alokitobangladesh.com and numeric IDs)
        article_links = [l for l in article_links if 'alokitobangladesh.com' in l and re.search(r'/\d+/?$', l)]
        ...
        if found_count > 0 and page < self.max_pages:
            next_page = page + 1
            next_url = f"https://www.alokitobangladesh.com/{cat_slug}?page={next_page}"
