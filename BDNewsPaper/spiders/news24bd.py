"""
News24 BD Spider (Bangla)
=========================
Scrapes articles from News24 BD (news24bd.tv)

Features:
    - RSS feed as primary source (~65 items)
...
class News24BDSpider(BaseNewsSpider):
    """
    Spider for News24 BD (TV News Portal).

    Uses RSS feed as primary source, with HTML scraping fallback.

    Usage:
        scrapy crawl news24bd -a categories=bangladesh,sports
        scrapy crawl news24bd -a max_pages=10
    """

    name = 'news24bd'
    paper_name = 'News24 BD'
    allowed_domains = ['news24bd.tv', 'www.news24bd.tv']
    language = 'Bangla'
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info(f"News24 BD spider initialized")
    ...
    def start_requests(self) -> Generator[Request, None, None]:
        ...
        # Primary: RSS feed (~65 items, fresh)
        self.stats['requests_made'] += 1
        yield Request(
            url='https://news24bd.tv/rss.xml',
        ...
        if self.categories:
            for category in self.categories:
                ...
                if cat_lower in self.CATEGORIES:
                    ...
                    cat_slug = cat_lower
                url = f"https://www.news24bd.tv/{cat_slug}"
    ...
    def parse_category(self, response: Response) -> Generator:
        ...
        article_links = [l for l in article_links if 'news24bd.tv' in l and re.search(r'/\d+$', l)]
        ...
        if found_count > 0 and page < self.max_pages:
            next_page = page + 1
            next_url = f"https://www.news24bd.tv/{cat_slug}?page={next_page}"
