"""
Gramer Kagoj Spider (Bangla)
============================
Scrapes articles from Gramer Kagoj (gramerkagoj.com)

Features:
    - Jessore regional news
...
class GramerKagojSpider(BaseNewsSpider):
    """
    Spider for Gramer Kagoj (Jessore Regional).
    
    Regional news from Jessore/Khulna area.
    
    Usage:
        scrapy crawl gramerkagoj
        scrapy crawl gramerkagoj -a max_pages=10
    """
    
    name = 'gramerkagoj'
    paper_name = 'Gramer Kagoj'
    ...
    def parse_category(self, response: Response) -> Generator:
        ...
        for url in article_links:
            if not url.startswith('http'):
                url = f"https://gramerkagoj.com{url}"
