...
===========================
Scrapes articles from Bonik Barta (bonikbarta.net) - Leading Bangla Business Daily
...
class BonikBartaSpider(BaseNewsSpider):
    ...
    allowed_domains = ['bonikbarta.net', 'www.bonikbarta.net']
    language = 'Bangla'
    ...
    def start_requests(self) -> Generator[Request, None, None]:
        ...
        if self.categories:
            for category in self.categories:
                ...
                url = f"https://www.bonikbarta.net/{cat_slug}"
            ...
            for cat in default_cats:
                url = f"https://www.bonikbarta.net/{cat}"
    ...
    def parse_category(self, response: Response) -> Generator:
        ...
        # Filter to article links (contain bonikbarta.net and numeric IDs)
        article_links = [l for l in article_links if 'bonikbarta.net/' in l and re.search(r'/\d+$', l)]
        ...
        if found_count > 0 and page < self.max_pages:
            next_page = page + 1
            next_url = f"https://www.bonikbarta.net/{cat_slug}?page={next_page}"
