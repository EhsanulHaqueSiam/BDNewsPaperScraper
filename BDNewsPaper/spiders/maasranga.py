...
class MaasrangaSpider(BaseNewsSpider):
    ...
    Uses the WP JSON API for efficient data extraction.
    ...
    # WordPress API base
    API_BASE = 'https://maasranga.tv/wp-json/wp/v2'
    POSTS_PER_PAGE = 20
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info("Maasranga TV spider initialized (WordPress API)")
