"""
Netrokona 24 Spider (Bangla)
============================
Scrapes articles from Netrokona 24 (netrokona24.com)

Features:
    - Netrokona/Mymensingh regional news
...
class Netrokona24Spider(BaseNewsSpider):
    """
    Spider for Netrokona 24 (Netrokona Regional).
    
    Regional news from Netrokona district in Mymensingh.
    
    Usage:
        scrapy crawl netrokona24
        scrapy crawl netrokona24 -a max_pages=10
    """
    
    name = 'netrokona24'
    paper_name = 'Netrokona 24'
    allowed_domains = ['netrokona24.com']
    language = 'Bangla'
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info("Netrokona 24 spider initialized (Netrokona Regional)")
    ...
    def start_requests(self):
        ...
        yield Request(
            url='https://www.netrokona24.com/feed',
    ...
    def parse_category(self, response: Response) -> Generator:
        ...
        # Extract article links - /archives/ID pattern
        article_links = response.css('a::attr(href)').getall()
        article_links = [
            l for l in article_links
            if 'netrokona24.com/archives/' in l
            and re.search(r'/archives/\d+$', l)  # Article ID pattern
        ]
        ...
        for url in article_links:
            if not url.startswith('http'):
                url = f"https://netrokona24.com{url}"
        ...
        if found_count > 0 and page < self.max_pages:
            ...
            if next_page_link:
                if not next_page_link.startswith('http'):
                    next_page_link = f"https://netrokona24.com{next_page_link}"
