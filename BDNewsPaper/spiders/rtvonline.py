"""
RTV Online Spider (Bangla)
==========================
Scrapes articles from RTV Online (rtvonline.com)

Features:
    - RSS feed as primary source (~200 items)
...
class RTVOnlineSpider(BaseNewsSpider):
    """
    Spider for RTV Online (TV News Portal).

    Uses RSS feed as primary source, with HTML scraping fallback.

    Usage:
        scrapy crawl rtvonline -a categories=national,sports
        scrapy crawl rtvonline -a max_pages=10
    """

    name = 'rtvonline'
    paper_name = 'RTV Online'
    allowed_domains = ['rtvonline.com', 'www.rtvonline.com']
    language = 'Bangla'
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info(f"RTV Online spider initialized")
    ...
    def start_requests(self) -> Generator[Request, None, None]:
        ...
        # Primary: RSS feed (~200 items, fresh)
        self.stats['requests_made'] += 1
        yield Request(
            url='https://rtvonline.com/rss/rss.xml',
        ...
        if self.categories:
            for category in self.categories:
                ...
                if cat_lower in self.CATEGORIES:
                    ...
                    cat_slug = cat_lower
                url = f"https://www.rtvonline.com/{cat_slug}"
            ...
            default_cats = ['bangladesh', 'politics', 'sports', 'international']
    ...
    def parse_category(self, response: Response) -> Generator:
        ...
        # Filter to article links (contain rtvonline.com and numeric IDs)
        article_links = [l for l in article_links if 'rtvonline.com' in l and re.search(r'/\d+$', l)]
        ...
        if found_count > 0 and page < self.max_pages:
            next_page = page + 1
            next_url = f"https://www.rtvonline.com/{cat_slug}?page={next_page}"
