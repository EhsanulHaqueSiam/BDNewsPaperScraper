"""
Comillar Kagoj Spider (Bangla)
==============================
Scrapes articles from Comillar Kagoj (comillarkagoj.com)

Features:
    - Comilla regional news
...
class ComillarKagojSpider(BaseNewsSpider):
    """
    Spider for Comillar Kagoj (Comilla Regional).
    
    Regional news from Comilla/Cumilla district.
    
    Usage:
        scrapy crawl comillarkagoj
        scrapy crawl comillarkagoj -a max_pages=10
    """
    
    name = 'comillarkagoj'
    paper_name = 'Comillar Kagoj'
    allowed_domains = ['comillarkagoj.com']
    language = 'Bangla'
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info("Comillar Kagoj spider initialized (Comilla Regional)")
    ...
    def start_requests(self):
        ...
        yield Request(
            url='https://comillarkagoj.com/feed',
    ...
    def parse_category(self, response: Response) -> Generator:
        ...
        for url in article_links:
            if not url.startswith('http'):
                url = f"https://comillarkagoj.com{url}"
