"""
Narayanganj Times Spider (Bangla)
=================================
Scrapes articles from Narayanganj Times (narayanganjtimes.com)

Features:
    - Regional news from Narayanganj
...
class NarayanganjtimesSpider(BaseNewsSpider):
    """
    Spider for Narayanganj Times (Regional Bangla).
    
    District-level news from Narayanganj.
    
    Usage:
        scrapy crawl narayanganjtimes -a max_pages=10
    """
    
    name = 'narayanganjtimes'
    paper_name = 'Narayanganj Times'
    allowed_domains = ['narayanganjtimes.com', 'www.narayanganjtimes.com']
    language = 'Bangla'
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info("Narayanganj Times spider initialized (Regional)")
    ...
    def start_requests(self):
        ...
        yield Request(
            url='https://www.narayanganjtimes.com/rss/rss.xml',
    ...
    def _generate_fallback_requests(self) -> Generator[Request, None, None]:
        ...
        # Default: main page
        url = "https://narayanganjtimes.com/"
        self.stats['requests_made'] += 1
        yield Request(
            url=url,
    ...
    def parse_category(self, response: Response) -> Generator:
        ...
        for url in article_links:
            if not url.startswith('http'):
                url = f"https://narayanganjtimes.com{url}"
        ...
        if found_count > 0 and page < self.max_pages:
            ...
            if next_page_link:
                if not next_page_link.startswith('http'):
                    next_page_link = f"https://narayanganjtimes.com{next_page_link}"
