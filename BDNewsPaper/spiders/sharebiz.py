"""
ShareBiz Spider (Bangla)
========================
Scrapes articles from ShareBiz (sharebiz.net)

Features:
    - WordPress REST API support ⚡
    - Stock market and business news in Bangla
...
class ShareBizSpider(BaseNewsSpider):
    """
    Spider for ShareBiz using WordPress REST API.
    
    Bangla stock market and business news portal.
    
    Usage:
        scrapy crawl sharebiz
        scrapy crawl sharebiz -a max_pages=10
    """
    
    name = 'sharebiz'
    paper_name = 'ShareBiz'
    allowed_domains = ['sharebiz.net']
    language = 'Bangla'
    ...
    # WordPress API base
    API_BASE = 'https://sharebiz.net/wp-json/wp/v2'
    POSTS_PER_PAGE = 20
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info("ShareBiz spider initialized (WordPress API)")
    ...
    def start_requests(self):
        ...
        yield Request(
            url='https://www.sharebiz.net/feed',
        ...
        self.stats['requests_made'] += 1
        yield Request(
            url='https://www.sharebiz.net/sitemap.xml',
