"""
Sylhet Mirror Spider (English)
==============================
Scrapes articles from Sylhet Mirror (sylhetmirror.com)
...
class SylhetMirrorSpider(BaseNewsSpider):
    """
    Spider for Sylhet Mirror (Regional English News).
    
    Covers news from Sylhet, Moulvibazar, Sunamganj, and Habiganj.
    
    Usage:
        scrapy crawl sylhetmirror -a categories=sylhet,uk
        scrapy crawl sylhetmirror -a max_pages=10
    """
    
    name = 'sylhetmirror'
    paper_name = 'Sylhet Mirror'
    allowed_domains = ['sylhetmirror.com', 'www.sylhetmirror.com']
    language = 'English'
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info("Sylhet Mirror spider initialized (Regional)")
    ...
    def start_requests(self):
        ...
        yield Request(
            url='https://www.sylhetmirror.com/feed',
    ...
    def _generate_fallback_requests(self) -> Generator[Request, None, None]:
        ...
        if self.categories:
            for category in self.categories:
                ...
                url = f"https://sylhetmirror.com/category/{cat_slug}/"
    ...
    def parse_category(self, response: Response) -> Generator:
        ...
        for url in article_links:
            if not url.startswith('http'):
                url = f"https://sylhetmirror.com{url}"
        ...
        if found_count > 0 and page < self.max_pages:
            ...
            if next_page_link:
                if not next_page_link.startswith('http'):
                    next_page_link = f"https://sylhetmirror.com{next_page_link}"
